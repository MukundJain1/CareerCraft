...
class _HomePageState extends State<AIHomePage> {
  ...
  void initState() {
    super.initState();
    message = {'response0':'Greetings, How can I help you?','prompt0':''}; // Initialize the map here
  }
        ...
        Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/icons/virtualAssistant.png'),
            ),
          ),
        ),
                    ...
                    child: message!['response$index'] == "waiting"
                        ? Container(
                            ...
                            child: CircularProgressIndicator(
                                color: primary2, strokeWidth: 3.sp),
                          )
                        : SizedBox(
                          width: 280.w,
                          child: Container(
