            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    schoolingCard("Primary", 'assets/icons/primary.png', ps,
                        () {
                      setState(() {
                        ps = 1;
                        hs = 0;
                    ...
                    schoolingCard("Secondary", 'assets/icons/secodary.png', ss,
                        () {
                      ss = 1;
                      hs = 0;
                      ps = 0;
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    schoolingCard("Higher", 'assets/icons/higher.png', hs, () {
                      hs = 1;
                      ss = 0;
                      its = 0;
                      ps = 0;
                    ...
                    schoolingCard("Intermediate", 'assets/icons/inter.png', its,
                        () {
                      setState(() {
                        its = 1;
                        ps = 0;
